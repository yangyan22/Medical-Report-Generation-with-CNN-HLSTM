...
class DebuggerBase:
    ...
    def train(self):
        ...
        for epoch_id in range(self.start_epoch, self.args.epochs):
            ...
            stop_loss, word_loss, train_loss = self._epoch_train()
...
class LSTMDebugger(DebuggerBase):
    ...
    def _epoch_train(self):
        ...
        for i, (images1, images2, targets, prob, id) in enumerate(progress_bar):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_path', type=str, default='/media/camlab1/doc_drive/IU_data/images_R2_Ori/vocab.pkl', help='path for vocabulary')
    ...
    RESUME_MODEL_PATH = './models/2021-11-05 11:03/train_best.pth.tar'
